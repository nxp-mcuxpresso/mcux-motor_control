...
RAM_FUNC_LIB
extern MCAA_ESTIMRLINIT_RET_T_FLT MCAA_EstimRLInit_FLT_FCRam(uint32_t u32SamplingFreq,
                                                            MCAA_ESTIMRL_INIT_T_FLT *psParam,
                                                            MCAA_ESTIMRL_T_FLT *const psCtrl);
...
RAM_FUNC_LIB
extern MCAA_ESTIMRL_RET_T_FLT MCAA_EstimRL_FLT_FCRam(float_t fltUDcBus,
                                                     const GMCLIB_2COOR_ALBE_T_FLT *const pIAlBeFbck,
                                                     MCAA_ESTIMRL_T_FLT *const psCtrl,
                                                     MCAA_ESTIMRL_RUN_T_FLT *psParam,
                                                     GMCLIB_2COOR_ALBE_T_FLT *const pUAlBeReq);
