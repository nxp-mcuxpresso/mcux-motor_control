...
#include "mcdrv_adc_single_adc16.h"
    ...
    switch (*this->pui16SVMSector)
    {
        ...
        case 3:
            ...
            sIABCtemp.f16C = (frac16_t)(
                MLIB_ShLSat_F16((this->sCurrSec23.pui32AdcBasePhaC->R[1] - this->sCurrSec23.ui16OffsetPhaC), 4));
        ...
        case 5:
            ...
            sIABCtemp.f16B = (frac16_t)(
                MLIB_ShLSat_F16((this->sCurrSec45.pui32AdcBasePhaB->R[1] - this->sCurrSec45.ui16OffsetPhaB), 4));
        ...
        default:
            ...
            sIABCtemp.f16C = (frac16_t)(
                MLIB_ShLSat_F16((this->sCurrSec16.pui32AdcBasePhaC->R[1] - this->sCurrSec16.ui16OffsetPhaC), 4));
...
void MCDRV_Curr3Ph2ShChanAssignInit(mcdrv_adc16_t *this)
{
    ...
    this->sCurrSec16.pui32AdcBasePhaC->SC1[1] =
        ((this->sCurrSec16.pui32AdcBasePhaC->SC1[1] & ~(uint16_t)ADC_SC1_ADCH_MASK) | this->sCurrSec16.ui16ChanNumPhaC);

    /* Vdcb sampling - select SC1[1] (sample number 1) */
    this->pui32UdcbAdcBase->SC1[2] =
        ((this->pui32UdcbAdcBase->SC1[2] & ~(uint16_t)ADC_SC1_ADCH_MASK) | this->ui16ChanNumVDcb);
...
void MCDRV_Curr3Ph2ShChanAssign(mcdrv_adc16_t *this)
{
    ...
    switch (*this->pui16SVMSector)
    {
        ...
        case 3: /* currents Ia, Ic will be measured */
            ...
            this->sCurrSec23.pui32AdcBasePhaC->SC1[1] =
                ((this->sCurrSec23.pui32AdcBasePhaC->SC1[1] & ~(uint16_t)ADC_SC1_ADCH_MASK) |
        ...
        case 5: /*  currents Ia, Ib will be measured */
            ...
            this->sCurrSec45.pui32AdcBasePhaB->SC1[1] =
                ((this->sCurrSec45.pui32AdcBasePhaB->SC1[1] & ~(uint16_t)ADC_SC1_ADCH_MASK) |
        ...
        default:
            ...
            this->sCurrSec16.pui32AdcBasePhaC->SC1[1] =
                ((this->sCurrSec16.pui32AdcBasePhaC->SC1[1] & ~(uint16_t)ADC_SC1_ADCH_MASK) |
...
void MCDRV_Curr3Ph2ShCalib(mcdrv_adc16_t *this)
{
    ...
    switch (*this->pui16SVMSector)
    {
        ...
        case 3:
            ...
            this->sCurrSec23.ui16CalibPhaC = GDFLIB_FilterMA_F16((frac16_t)(this->sCurrSec23.pui32AdcBasePhaC->R[1]),
        ...
        case 5:
            ...
            this->sCurrSec45.ui16CalibPhaB = GDFLIB_FilterMA_F16((frac16_t)(this->sCurrSec45.pui32AdcBasePhaB->R[1]),
        ...
        default:
            ...
            this->sCurrSec16.ui16CalibPhaC = GDFLIB_FilterMA_F16((frac16_t)(this->sCurrSec16.pui32AdcBasePhaC->R[1]),
...
void MCDRV_VoltDcBusGet(mcdrv_adc16_t *this)
{
    ...
    *this->pf16UDcBus = (frac16_t)(MLIB_ShLSat_F16((this->pui32UdcbAdcBase->R[2]), 3));
