...
void MCDRV_Curr3Ph2ShGet(mcdrv_adc_t *this)
{
    ...
    switch (*this->pui16SVMSector)
    {
        ...
        case 3:
            ...
            sIABCtemp.f16A = MLIB_ShLSat_F16(((frac16_t)((int16_t)(ADC_ETC_GetADCConversionValue(ADC_ETC, 0U, 0U)*23/10) << 2U) - this->sCurrSec23.ui16OffsetPhaA), 1);
            sIABCtemp.f16C = MLIB_ShLSat_F16(((frac16_t)((int16_t)(ADC_ETC_GetADCConversionValue(ADC_ETC, 4U, 0U)*23/10) << 2U) - this->sCurrSec23.ui16OffsetPhaC), 1);
        ...
        case 5:
            ...
            sIABCtemp.f16A = MLIB_ShLSat_F16(((frac16_t)((int16_t)(ADC_ETC_GetADCConversionValue(ADC_ETC, 0U, 0U)*23/10) << 2U) - this->sCurrSec45.ui16OffsetPhaA), 1);
            sIABCtemp.f16B = MLIB_ShLSat_F16(((frac16_t)((int16_t)(ADC_ETC_GetADCConversionValue(ADC_ETC, 4U, 0U)*23/10) << 2U) - this->sCurrSec45.ui16OffsetPhaB), 1);
        ...
        default:
            ...
            sIABCtemp.f16B = MLIB_ShLSat_F16(((frac16_t)((int16_t)(ADC_ETC_GetADCConversionValue(ADC_ETC, 0U, 0U)*23/10) << 2U) - this->sCurrSec16.ui16OffsetPhaB), 1);
            sIABCtemp.f16C = MLIB_ShLSat_F16(((frac16_t)((int16_t)(ADC_ETC_GetADCConversionValue(ADC_ETC, 4U, 0U)*23/10) << 2U) - this->sCurrSec16.ui16OffsetPhaC), 1);
...
void MCDRV_Curr3Ph2ShCalib(mcdrv_adc_t *this)
{
    ...
    switch (*this->pui16SVMSector)
    {
        ...
        case 3:
            ...
            this->sCurrSec23.ui16CalibPhaA = GDFLIB_FilterMA_F16((frac16_t)((ADC_ETC_GetADCConversionValue(ADC_ETC, 0U, 0U)*23/10) << 2), &this->sCurrSec23.ui16FiltPhaA);
            this->sCurrSec23.ui16CalibPhaC = GDFLIB_FilterMA_F16((frac16_t)((ADC_ETC_GetADCConversionValue(ADC_ETC, 4U, 0U)*23/10) << 2), &this->sCurrSec23.ui16FiltPhaC);
            break;
        case 4:
        case 5:
            /* sensing of offset IA -> ADCA and IB -> ADCC */
            this->sCurrSec45.ui16CalibPhaA = GDFLIB_FilterMA_F16((frac16_t)((ADC_ETC_GetADCConversionValue(ADC_ETC, 0U, 0U)*23/10) << 2), &this->sCurrSec45.ui16FiltPhaA);
            this->sCurrSec45.ui16CalibPhaB = GDFLIB_FilterMA_F16((frac16_t)((ADC_ETC_GetADCConversionValue(ADC_ETC, 4U, 0U)*23/10) << 2), &this->sCurrSec45.ui16FiltPhaB);
            break;
        case 1:
        case 6:
        default:
            /* sensing of offset IB -> ADCA and IC -> ADCC */
            this->sCurrSec16.ui16CalibPhaB = GDFLIB_FilterMA_F16((frac16_t)((ADC_ETC_GetADCConversionValue(ADC_ETC, 0U, 0U)*23/10) << 2), &this->sCurrSec16.ui16FiltPhaB);
            this->sCurrSec16.ui16CalibPhaC = GDFLIB_FilterMA_F16((frac16_t)((ADC_ETC_GetADCConversionValue(ADC_ETC, 4U, 0U)*23/10) << 2), &this->sCurrSec16.ui16FiltPhaC);
            break;
    }
...
void MCDRV_VoltDcBusGet(mcdrv_adc_t *this)
{
    ...
    *this->pf16UDcBus = (frac16_t)((ADC_ETC_GetADCConversionValue(ADC_ETC, 0U, 1U)*23/10) << 2); //ADC_ETC trigger0 (ADC1) chain1 
