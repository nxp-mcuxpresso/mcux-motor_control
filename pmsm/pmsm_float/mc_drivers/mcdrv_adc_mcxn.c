...
void MCDRV_CurrAndVoltDcBusGet(mcdrv_adc_t *this)
{
    ...
    /* Command 1 */
    this->ui16AdcCurrA = (uint16_t)((this->pToAdcBase->RESFIFO[0] & ADC_RESFIFO_D_MASK) << 1U);
    
    /* Command 2 */
    this->ui16AdcCurrB = (uint16_t)((this->pToAdcBase->RESFIFO[0] & ADC_RESFIFO_D_MASK) << 1U);
    
    /* Command 3 */
    this->ui16AdcCurrC = (uint16_t)((this->pToAdcBase->RESFIFO[0] & ADC_RESFIFO_D_MASK) << 1U);
    
    /* Command 4 */
    this->ui16AdcDCBVolt = (uint16_t)(this->pToAdcBase->RESFIFO[0] & ADC_RESFIFO_D_MASK);
