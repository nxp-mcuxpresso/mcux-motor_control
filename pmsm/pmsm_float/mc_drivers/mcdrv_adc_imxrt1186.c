...
void MCDRV_CurrAndVoltDcBusGet(mcdrv_adc_t *this)
{
    ...
    /* FIFO_0 - conversion 2 - UDCBus */
    this->ui16AdcDCBVolt = ((int16_t)(((uint16_t)(ADC1->RESFIFO[0] & ADC_RESFIFO_D_MASK))*12/11));
    *this->pf16UDcBus    = (frac16_t)(this->ui16AdcDCBVolt);
    /* FIFO_1 - conversion 2 - dummy sample */
    ui16Dummy = (ADC1->RESFIFO[1] & ADC_RESFIFO_D_MASK);

    /* ADC2 */
    /* FIFO_0 - conversion 1 - dummy sample */
    ui16Dummy = (ADC2->RESFIFO[0] & ADC_RESFIFO_D_MASK);  
    
    /* warning suppression  */
    NOT_USED(ui16Dummy);
    
    /* FIFO_1 - conversion 1 - I_C */
    this->ui16AdcCurrC = ((int16_t)(((uint16_t)(ADC2->RESFIFO[1] & ADC_RESFIFO_D_MASK))*12/11));
