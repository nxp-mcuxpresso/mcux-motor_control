    ...
    switch (*this->pui16SVMSector)
    {
        ...
        case 3:
            ...
            sIABCtemp.f16A = MLIB_ShLSat_F16(
                ((frac16_t)((int16_t)(this->sCurrSec23.pAdcBasePhaA->R[this->sCurrSec23.ui16RsltRegPhaA]) << 3U) -
                 this->sCurrSec23.ui16OffsetPhaA),
                1);

            sIABCtemp.f16C = MLIB_ShLSat_F16(
                ((frac16_t)((int16_t)(this->sCurrSec23.pAdcBasePhaC->R[this->sCurrSec23.ui16RsltRegPhaC]) << 3U) -
        ...
        case 5:
            ...
            sIABCtemp.f16A = MLIB_ShLSat_F16(
                ((frac16_t)((int16_t)(this->sCurrSec45.pAdcBasePhaA->R[this->sCurrSec45.ui16RsltRegPhaA]) << 3U) -
                 this->sCurrSec45.ui16OffsetPhaA),
                1);

            sIABCtemp.f16B = MLIB_ShLSat_F16(
                ((frac16_t)((int16_t)(this->sCurrSec45.pAdcBasePhaB->R[this->sCurrSec45.ui16RsltRegPhaB]) << 3U) -
        ...
        default:
            ...
            sIABCtemp.f16B = MLIB_ShLSat_F16(
                ((frac16_t)((int16_t)(this->sCurrSec16.pAdcBasePhaB->R[this->sCurrSec16.ui16RsltRegPhaB]) << 3U) -
                 this->sCurrSec16.ui16OffsetPhaB),
                1);

            sIABCtemp.f16C = MLIB_ShLSat_F16(
                ((frac16_t)((int16_t)(this->sCurrSec16.pAdcBasePhaC->R[this->sCurrSec16.ui16RsltRegPhaC]) << 3U) -
...
void MCDRV_Curr3Ph2ShChanAssignInit(mcdrv_adc_t *this)
{
    ...
    this->sCurrSec16.pui16HCPhaC = (uint16_t *)&this->sCurrSec16.pAdcBasePhaC->HC[this->sCurrSec16.ui16RsltRegPhaC];

    /* sector 2&3, direct sensing of phases A and C */
    this->sCurrSec23.pui16HCPhaA = (uint16_t *)&this->sCurrSec23.pAdcBasePhaA->HC[this->sCurrSec23.ui16RsltRegPhaA];
    this->sCurrSec23.pui16HCPhaC = (uint16_t *)&this->sCurrSec23.pAdcBasePhaC->HC[this->sCurrSec23.ui16RsltRegPhaC];

    /* sector 4&5, direct sensing of phases A and B */
    this->sCurrSec45.pui16HCPhaA = (uint16_t *)&this->sCurrSec45.pAdcBasePhaA->HC[this->sCurrSec45.ui16RsltRegPhaA];
    this->sCurrSec45.pui16HCPhaB = (uint16_t *)&this->sCurrSec45.pAdcBasePhaB->HC[this->sCurrSec45.ui16RsltRegPhaB];
    ...
    switch (*this->pui16SVMSector)
    {
        ...
        case 3:
            ...
            this->sCurrSec23.ui16CalibPhaA =
                GDFLIB_FilterMA_F16((frac16_t)(this->sCurrSec23.pAdcBasePhaA->R[this->sCurrSec23.ui16RsltRegPhaA] << 3),
                                    &this->sCurrSec23.ui16FiltPhaA);
            this->sCurrSec23.ui16CalibPhaC =
                GDFLIB_FilterMA_F16((frac16_t)(this->sCurrSec23.pAdcBasePhaC->R[this->sCurrSec23.ui16RsltRegPhaC] << 3),
        ...
        case 5:
            ...
            this->sCurrSec45.ui16CalibPhaA =
                GDFLIB_FilterMA_F16((frac16_t)(this->sCurrSec45.pAdcBasePhaA->R[this->sCurrSec45.ui16RsltRegPhaA] << 3),
                                    &this->sCurrSec45.ui16FiltPhaA);
            this->sCurrSec45.ui16CalibPhaB =
                GDFLIB_FilterMA_F16((frac16_t)(this->sCurrSec45.pAdcBasePhaB->R[this->sCurrSec45.ui16RsltRegPhaB] << 3),
        ...
        default:
            ...
            this->sCurrSec16.ui16CalibPhaB =
                GDFLIB_FilterMA_F16((frac16_t)(this->sCurrSec16.pAdcBasePhaB->R[this->sCurrSec16.ui16RsltRegPhaB] << 3),
                                    &this->sCurrSec16.ui16FiltPhaB);
            this->sCurrSec16.ui16CalibPhaC =
                GDFLIB_FilterMA_F16((frac16_t)(this->sCurrSec16.pAdcBasePhaC->R[this->sCurrSec16.ui16RsltRegPhaC] << 3),
...
void MCDRV_VoltDcBusGet(mcdrv_adc_t *this)
{
    ...
    *this->pf16UDcBus = (frac16_t)((this->pui32UdcbAdcBase->R[this->ui16RsltRegVDcb]) << 3);
