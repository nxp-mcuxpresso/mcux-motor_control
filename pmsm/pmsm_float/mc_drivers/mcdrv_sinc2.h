...
#ifndef _MCDRV_SINC2_H_
#define _MCDRV_SINC2_H_
...
typedef struct _mcdrv_sinc
{
  ...
  const uint8_t ui8ChannelCurrA;
  const uint8_t ui8ChannelCurrB;
  const uint8_t ui8ChannelCurrC;
  const uint8_t ui8ChannelVoltDCB;
