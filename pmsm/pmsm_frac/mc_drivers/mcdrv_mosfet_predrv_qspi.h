...
#ifndef _MCDRV_MOSFET_PREDRV_QSPI_H_
#define _MCDRV_MOSFET_PREDRV_QSPI_H_
...
{
	QSPI_Type *pSpiBase; /* QSPI base address */
	
    GPIO_Type *pGpioEnBase; /* PORT status register for driver enabled */
    gpio_pin_t ui16GpioEnPin; /* pin number for driver enabled */

    GPIO_Type *pGpioIntBase; /* PORT status register for interrupt detection */
    uint16_t ui16GpioIntPin; /* pin number for interrupt detection */

    GPIO_Type *pGpioResetBase; /* PORT status register for reset */
    uint16_t ui16GpioResetPin; /* pin number for reset, driver */

    uint16_t ui16Pcs; /* Chip select pin */
...
#endif /* _MCDRV_MOSFET_PREDRV_QSPI_H_ */
