...
void MCDRV_CurrAndVoltDcBusGet(mcdrv_adc_t *this)
{
    ...
    // IA
    this->ui16AdcCurrA = ((ADC0->DAT[CUR_A_CHANNEL_NUMBER]) & ADC_DAT_RESULT_MASK);
    
    // IB
    this->ui16AdcCurrB = ((ADC0->DAT[CUR_B_CHANNEL_NUMBER]) & ADC_DAT_RESULT_MASK);
    
    // IC
    this->ui16AdcCurrC = ((ADC0->DAT[CUR_C_CHANNEL_NUMBER]) & ADC_DAT_RESULT_MASK);
    
    // UDCB
    this->ui16AdcDCBVolt = ((ADC0->DAT[VOLT_DCB_CHANNEL_NUMBER]) & ADC_DAT_RESULT_MASK) >> 1U;
