...
typedef struct _mcdef_fault_thresholds_t
{
	...
	frac16_t f16UDcBusTrip;      /* DC bus voltage level to start braking */
...
typedef struct _mcdef_pmsm_t
{
    ...
    GDFLIB_FILTER_MA_T_A32 msM1BlockedRotorUqFilt; /* M1 Blocked rotor detection filter */
    GDFLIB_FILTER_MA_T_A32 msM2BlockedRotorUqFilt; /* M2 Blocked rotor detection filter */
    ...
    frac16_t f16SpeedEnc;                          /* Encoder speed */
    frac16_t f16SpeedEncEl;					 	   /* Encoder electric speed */
