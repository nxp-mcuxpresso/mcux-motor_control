...
#define PWM_OFF_SECTOR 7 /* Sector number for disable all PWM signals */
...
typedef struct _mcdef_bldc_t
{
    ...
    mcdef_fault_t sFaultIdCaptured;            /* Application motor faults */
...
extern m1_run_substate_t s_eM1StateRun;
