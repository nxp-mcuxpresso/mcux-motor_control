...
static void M1_StateFaultFast(void)
{
    ...
    g_sM1AdcSensor.ui16Sector = (uint16_t)g_sM1Drive.sCtrlBLDC.i16SectorCmt;
...
static void M1_StateInitFast(void)
{
    ...
    g_sM1Drive.ui16FreqCtrlLoop = M1_SPEED_LOOP_FREQ; 
    g_sM1Drive.ui16FreqPwm      = M1_PWM_FREQ;
...
static void M1_StateStopFast(void)
{
    ...
    if ((g_bM1SwitchAppOnOff != FALSE) || (bool_t)(g_sM1Drive.sCtrlBLDC.f16SpeedCmd != FRAC16(0.0)))
    {
        /* Set the switch on */
...
static void M1_TransInitFault(void)
{
    ...
    /* disable PWM outputs */
    M1_MCDRV_PWM3PH_SET_PWM_OUTPUT(&g_sM1Pwm3ph, PWM_OFF_SECTOR);
...
static void M1_StateRunSpinFast(void)
{
    ...
    if ((uint16_t)MLIB_SubSat_F16(g_sM1Drive.ui16TimeCurrent, g_sM1Drive.ui16TimeOfCmt) >= g_sM1Drive.ui16PeriodToff)
    {
        ...
        if (g_sM1Drive.f32UBemfIntegSum >= g_sM1Drive.f32UBemfIntegThreshold)
        {
            ...
            if ((uint16_t)MLIB_SubSat_F16(g_sM1Drive.ui16TimeCurrent, g_sM1Drive.ui16TimeOfCmt) < (M1_CMT_PER_MIN >> 1U))
            {
            ...
            g_sM1Drive.ui16TimeNextEvent = (uint16_t)(MLIB_Add_F16((int16_t)g_sM1Drive.ui16TimeCurrent, (int16_t)g_sM1Drive.ui16PeriodCmtNext));
...
static void M1_StateRunReadySlow(void)
{
    ...
    if (MLIB_AbsSat_F16(g_sM1Drive.sCtrlBLDC.f16SpeedCmd) > g_sM1Drive.sCtrlBLDC.f16SpeedMinimal)
    {
        ...
        {
            g_sM1Drive.sCtrlBLDC.ui16MotorDir = 0U;
        }   
        else
        {
            g_sM1Drive.sCtrlBLDC.ui16MotorDir = 1U;
        }
...
static void M1_TransRunStartupSpin(void)
{
    ...
    g_sM1Drive.ui16CounterCmtError = 0U;
    ...
    g_sM1Drive.ui16TimeNextEvent = (uint16_t)MLIB_Add_F16((int16_t)g_sM1Drive.ui16TimeCurrentEvent, (int16_t)(g_sM1Drive.ui16PeriodCmtNext << 1U));
    g_sM1Drive.ui16TimeOfCmt     = g_sM1Drive.ui16TimeCurrent;
    g_sM1Drive.f32UBemfIntegSum  = 0;
...
void M1_TimeEvent(void)
{
    ...
    switch (s_eM1StateRun)
    {
        ...
        case kRunState_Startup:
            ...
            g_sM1Drive.ui16TimeNextEvent = (uint16_t)MLIB_Add_F16((int16_t)g_sM1Drive.ui16TimeCurrentEvent, (int16_t)g_sM1Drive.ui16PeriodCmtNext);
