    ...
    switch (this->ui16Sector)
    {
        ...
        case 3:
            ...
            else
            {
                ...
                ADC0->SC1[this->ui16IndexAux] =
                    (ADC0->SC1[this->ui16IndexAux] & ~(uint16_t)(ADC_SC1_ADCH(ADC_SC1_ADCH_MASK))) |
        ...
        case 5:
            if ((this->bldcAdcSelCfg[this->ui16Sector]) == ADC0)
            {
                ...
                ADC1->SC1[this->ui16IndexAux] =
                    (ADC1->SC1[this->ui16IndexAux] & ~(uint16_t)(ADC_SC1_ADCH(ADC_SC1_ADCH_MASK))) |
                    (ADC_SC1_ADCH(MCDRV_TEMP));
            }
            else
                /* Set ADC_SC1_ADCH bitfield */
