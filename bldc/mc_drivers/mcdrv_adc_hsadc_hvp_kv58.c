...
bool_t MCDRV_AssignBemfChannel_hvp_kv58(mcdrv_hsadc_t *this)
{
    ...
    switch (this->ui16Sector)
    {
        ...
        case 1:
        case 4:
            this->pui32BemfBAdcBase->CLIST3 =
                ((this->pui32BemfBAdcBase->CLIST3 & ~(uint16_t)(HSADC_CLIST3_SAMPLE8_MASK)) |
        ...
        case 2:
        case 5:
            this->pui32BemfAAdcBase->CLIST3 =
                ((this->pui32BemfAAdcBase->CLIST3 & ~(uint16_t)(HSADC_CLIST3_SAMPLE8_MASK)) |
...
bool_t MCDRV_BemfVoltageGet_hvp_kv58(mcdrv_hsadc_t *this)
{
    ...
    switch (this->ui16Sector)
    {
        ...
        case 0:
        case 3:
            *this->pf16BemfVoltage = (frac16_t)(this->pui32Adc1Base->RSLT[this->ui16RsltNumBemf]);
            break;
